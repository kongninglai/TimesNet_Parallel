...
class M4Dataset:
    ...
    def load(training: bool = True, dataset_file: str = '../dataset/m4') -> 'M4Dataset':
        ...
        # info_file = os.path.join(dataset_file, 'm4_info_small.csv')
        # train_cache_file = os.path.join(dataset_file, 'training_small.npy')
        # test_cache_file = os.path.join(dataset_file, 'test_small.npy')
